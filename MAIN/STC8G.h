...
//增强型PWM1中断优先级控制
#define 	PWM1_Polity(n)			do{if(n == 0) IP3H &= ~PPWM1H, IP3 &= ~PPWM1; \
																if(n == 1) IP3H &= ~PPWM1H, IP3 |= PPWM1; \
																if(n == 2) IP3H |= PPWM1H, IP3 &= ~PPWM1; \
																if(n == 3) IP3H |= PPWM1H, IP3 |= PPWM1; \
															}while(0)
//增强型PWM2中断优先级控制
#define 	PWM2_Polity(n)			do{if(n == 0) IP3H &= ~PPWM2H, IP3 &= ~PPWM2; \
...
#define   ADC_90T    (3<<5)        //adc时间90T
#define   ADC_FLAG   (1<<4)        //adc软件清0
